...
class FrameTV:
    ...
    def push(self, jpeg: bytes) -> str | None:
        ...
        try:
            ...
            # Both mattes must match (both "none" by default); a mismatch
            # (matte=none but portrait_matte defaulting to shadowbox_polar) makes
            # newer Frames reject send_image with error -2.
            new_id = art.upload(
