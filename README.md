...
| **Detail** — recordings, description, and a Xeno-Canto **reference call** to compare against your own | **Hover** — any bird shows its name and today's count **Click** — any bird plays a reference call |
