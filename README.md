...
- **Detail modals** - per-species recording history with scrubbable
  ...
  the call, or both.
- **2,525 illustrations** - 1,285 species (North American + European /
...
The bundled library covers 1,285 species (North American + European / eBird
...
- **Some birds have no picture.** The most common question, and usually
  not a bug: the bundled library covers **1,285 species (North American +
...
└── www/             # source of truth: the app as a static page
    ...
    └── favicon.png
avian/
├── assets/          # 2,525 bundled illustrations + photo-cutout fallbacks
